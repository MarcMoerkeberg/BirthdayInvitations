...
const useEventStore = defineStore({
  ...
  actions: {
    async populateEventFromDbData(dbResultData: VueFirestoreQueryData<Event>) {
      ...
      Vi skyder festen igang Kl 17:00 på Havrevang med lidt bobler. Planen er herefter at vi griller (vejret har dog lidt at sige her), hvis nogen har allergier, må de meget gerne melde det ind i god tid, så menuen kan opdateres derefter. Menuen kan ses under menu punktet. 
